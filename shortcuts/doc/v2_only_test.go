...
func TestValidateDocsV2OnlyAllowsDefaultAndHiddenV2(t *testing.T) {
...
func TestValidateDocsV2OnlyRejectsV1(t *testing.T) {
	runtime := docsV2OnlyTestRuntime(t, "v1", false)
